 ...
 */
    ...
    /**
     * جلب جميع بيانات الاجهزه المتبرع بها من جدول الاجهزه 
     */
    $sql  = "SELECT * FROM devices WHERE status = 0";
    ...
    /**
     * فنكشن لجلب بيانات المتبرع من جدول المستخدمين
     */
    ...
    /**
     * فنكشن لجلب بيانات الجمعيه من جدول المستخدمين
     */
    ...
    <div class="container">
        <div class="p-4">
            <table class="table table-success table-striped">
                ...
                <tbody>
                    <?php/** لوب لعرض البيانات بالجدول **/ foreach($devices as $device) : ?>
                        <tr>
                            <td><?= $device['name'] ?></td>
                            <td><?= get_association($device['association']) ?></td>
                            <td><?= get_donor($device['donor']) ?></td>
                            <td>
                                <?php/** لوب  لعرض الصوره بالجدول **/ foreach(get_pics($device['id']) as $pic) : ?>
